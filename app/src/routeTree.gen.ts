...
const AppProjectsProjectIdTasksIndexRoute = AppProjectsProjectIdTasksIndexRouteImport.update({
  id: "/tasks/",
  path: "/tasks/",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
const AppProjectsProjectIdSpacesIndexRoute = AppProjectsProjectIdSpacesIndexRouteImport.update({
  id: "/spaces/",
  path: "/spaces/",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
const AppProjectsProjectIdSkillsIndexRoute = AppProjectsProjectIdSkillsIndexRouteImport.update({
  id: "/skills/",
  path: "/skills/",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
const AppProjectsProjectIdSettingsIndexRoute = AppProjectsProjectIdSettingsIndexRouteImport.update({
  id: "/settings/",
  path: "/settings/",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
const AppProjectsProjectIdPlansIndexRoute = AppProjectsProjectIdPlansIndexRouteImport.update({
  id: "/plans/",
  path: "/plans/",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
const AppProjectsProjectIdChatsIndexRoute = AppProjectsProjectIdChatsIndexRouteImport.update({
  id: "/chats/",
  path: "/chats/",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
const AppProjectsProjectIdPlansPlanSlugRoute = AppProjectsProjectIdPlansPlanSlugRouteImport.update({
  id: "/plans/$planSlug",
  path: "/plans/$planSlug",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
const AppProjectsProjectIdChatsChatIdRoute = AppProjectsProjectIdChatsChatIdRouteImport.update({
  id: "/chats/$chatId",
  path: "/chats/$chatId",
  getParentRoute: () => AppProjectsProjectIdRoute,
} as any);
...
const AppProjectsProjectIdRouteChildren: AppProjectsProjectIdRouteChildren = {
  ...
  AppProjectsProjectIdPlansPlanSlugRoute: AppProjectsProjectIdPlansPlanSlugRoute,
  ...
  AppProjectsProjectIdSettingsIndexRoute: AppProjectsProjectIdSettingsIndexRoute,
  ...
  AppProjectsProjectIdSpacesSpaceIdChatIdRoute: AppProjectsProjectIdSpacesSpaceIdChatIdRoute,
  AppProjectsProjectIdSpacesSpaceIdIndexRoute: AppProjectsProjectIdSpacesSpaceIdIndexRoute,
};
