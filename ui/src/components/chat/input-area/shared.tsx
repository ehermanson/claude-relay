...
export const MODELS = BUILTIN_PROVIDER_MODELS.claude;
export const CODEX_MODELS = BUILTIN_PROVIDER_MODELS.codex;
...
export const MODEL_COMMAND_OPTIONS = [
  {
    value: null,
    label: "Default",
...
export const CODEX_MODEL_COMMAND_OPTIONS = [
  {
    value: null,
    label: "Default",
    commandValue: "default",
...
export const REASONING_COMMAND_OPTIONS = [
  {
    value: null,
    label: "Default",
    commandValue: "default",
